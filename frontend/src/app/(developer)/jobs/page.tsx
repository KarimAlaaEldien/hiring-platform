            ...
            <Card className="overflow-hidden">
              ...
              <Card>
                <CardContent className="p-5">
                  <h3 className="font-bold text-black text-base mb-2">Join HiringPlatform</h3>
                  <p className="text-sm text-text-muted mb-4">Create a developer account to save jobs, apply, and track your applications.</p>
